...
#BOARD_PREBUILT_RECOVERY_DTBOIMAGE := $(PRODUCT_OUT)/dtbo/arch/$(TARGET_KERNEL_ARCH)/boot/dtbo.img
BOARD_PREBUILT_RECOVERY_DTBOIMAGE := $(TARGET_OUT_INTERMEDIATES)/DTBO_OBJ/arch/$(KERNEL_ARCH)/boot/dtbo.img
